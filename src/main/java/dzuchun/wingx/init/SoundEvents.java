...
public class SoundEvents {
	private static final DeferredRegister<SoundEvent> SOUNDS_REGISTY = DeferredRegister
	...
	private static RegistryObject<SoundEvent> register(ResourceLocation location) {
		return SOUNDS_REGISTY.register(location.getPath(), () -> new SoundEvent(location));
	}

	public static void registerSoundEvents(IEventBus bus) {
		SOUNDS_REGISTY.register(bus);
	}
